...
public class RenderLocomotive extends Render<EntityLocomotive> {
    ...
    public RenderLocomotive(RenderManager renderManager, RenderItem itemRenderer) {
        super(renderManager);
    ...
    public ItemStack getStackToRender(EntityLocomotive entity) {
        return new ItemStack(entity.loco);
    }
