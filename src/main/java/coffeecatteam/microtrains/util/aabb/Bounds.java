package coffeecatteam.microtrains.util.aabb;
...
public class Bounds {
    ...
    public AxisAlignedBB[] getRotatedBounds() {
        ...
        AxisAlignedBB boundsUp = CollisionHelper.getBlockBounds(EnumFacing.UP, this);
        AxisAlignedBB boundsDown = CollisionHelper.getBlockBounds(EnumFacing.DOWN, this);
        return new AxisAlignedBB[]{boundsSouth, boundsWest, boundsNorth, boundsEast, boundsUp, boundsDown};
    }
}
